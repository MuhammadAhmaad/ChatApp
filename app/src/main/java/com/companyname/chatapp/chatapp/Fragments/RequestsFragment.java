...
import com.companyname.chatapp.chatapp.Model.Requests;
...
//                        viewHolder.setStatus(user_list.getStatus());
        ...
        mRequestsList.scrollToPosition(current_position);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(POSITION, mRequestsList.getVerticalScrollbarPosition());
    }
}
